...
<body>
  ...
  <!--Header-part-->
  <div id="header">
    <h1><a href="daftar.php">Resto Unikom</a></h1>
  </div>
  <!--close-Header-part-->
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form action="" method="post" class="form-horizontal">
                ...
                <div class="control-group">
                  <label class="control-label">Level Pekerjaan</label>
                  <div class="controls">
                ...
                <div class="form-actions">
                  <button type="submit" name="kirim_daftar" class="btn btn-success"><i class='icon icon-save'></i>&nbsp;
                    Daftar</button>
                </div>
              </form>
              <?php
