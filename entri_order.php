      ...
      <div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Entri
        ...
        <ul>
          ...
          if ($r['id_level'] == 1) {
            ...
            <li class="active"> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a>
            </li>
                  ...
                  <div class="widget-box span12">
                    ...
                    <div class="widget-content">
                      <div class="alert alert-info alert-block">
                        ...
                        silahkan lakukan
                        proses pembayaran terlebih dahulu di kasir !
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <ul>
                            ...
                            while ($r_dt_makanan = mysqli_fetch_array($sql_data_makanan)) {
                              ...
                              <li class="span2">
                                ...
                                <div class="actions">
                                  <a class="lightbox_trigger" href="gambar/<?php echo $r_dt_makanan['gambar_masakan']; ?>"><i
                                ...
                                <table class="table table-bordered">
                                  <tbody>
                                    <tr>
                                      <td>
                                        <?php echo $r_dt_makanan['nama_masakan']; ?>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Harga / Porsi</td>
                                      <td>Rp.
                                        <?php echo $r_dt_makanan['harga']; ?>,-
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Stok</td>
                                      <td>
                                        <?php echo $r_dt_makanan['stok']; ?> Porsi
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                <form action="" method="post">
                                  ...
                                  if (in_array($r_dt_makanan['id_masakan'], $pesan)) {
                                    ?>
                                    <button type="submit" value="<?php echo $r_dt_makanan['id_masakan']; ?>" name="tambah_pesan"
                          ...
                          <tbody>
                            ...
                            while ($r_draft_pesan = mysqli_fetch_array($sql_draft_pesan)) {
                              ...
                              <tr class="odd gradeX">
                                ...
                                <input id="<?php echo "harga" . $r_draft_pesan['id_pesan']; ?>" class="span8" type="hidden"
                                  value="<?php echo $r_draft_pesan['harga']; ?>" />
                                <td>
                                  <center>
                                    <input id="<?php echo "jumlah" . $r_draft_pesan['id_pesan']; ?>" class="span8"
                                      name="jumlah<?php echo $r_draft_pesan['id_masakan']; ?>" type="number" value=""
                                      placeholder="" onchange="return operasi()" />
                                  </center>
                                </td>
                                <td>
                                  <form action="" method="post">
                                    <button type="submit" value="<?php echo $r_draft_pesan['id_pesan']; ?>" name="hapus_pesan"
