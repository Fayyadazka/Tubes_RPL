    ...
    <body>
      ...
      <div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri
        ...
        <ul>
          ...
          if ($r['id_level'] == 1) {
            ...
            <li class="active"> <a href="entri_transaksi.php"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a>
            </li>
                    ...
                    <table class="table table-bordered table-invoice-full">
                      <thead>
                        <tr>
                          ...
                          <th class="head1">Nama Pelayan</th>
                      ...
                      <tbody>
                        ...
                        while ($r_order = mysqli_fetch_array($sql_order)) {
                          ...
                          <tr>
                            ...
                            <td class="right">
                              <center>Rp.
                                <?php echo $r_order['total_harga']; ?>,-
                              </center>
                            </td>
                            <td>
                              <form action="" method="post">
                                <button type="submit" value="<?php echo $r_order['id_order']; ?>" name="edit_order"
                                  class="btn btn-success btn-mini"><i class='icon-pencil'></i>&nbsp;&nbsp;Transaksi
                                  &nbsp;&nbsp;</button>
                                <button type="submit" value="<?php echo $r_order['id_order']; ?>" name="hapus_order"
                                  class="btn btn-mini btn-danger"><i class='icon icon-trash'></i>&nbsp; Hapus</button>
                              </form>
                            </td>
                          </tr>
                          <?php
                      ...
                      <tbody>
                        ...
                        while ($r_sudah_order = mysqli_fetch_array($sql_sudah_order)) {
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo $r_sudah_order['waktu_pesan']; ?>
                            </td>
                            <td>
                              <?php echo $r_sudah_order['nama_user']; ?>
                            </td>
                            <td>
                              <?php echo $r_sudah_order['no_meja']; ?>
                            </td>
                            <td>Rp.
                              <?php echo $r_sudah_order['total_harga']; ?>,-
                            </td>
                            <td>
                              <form action="" method="post">
      ...
      <div class="row-fluid">
        <div id="footer" class="span12">
          <?php echo date('Y'); ?> &copy; Restaurant <a href="#">by henscorp</a>
        </div>
      </div>
