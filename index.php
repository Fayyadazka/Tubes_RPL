...
if (isset($_SESSION['username'])) {
	...
	<body>
		<div class="limiter">
			<div class="container-login100" style="background-image: url('template/masuk/image/bg.jpg');">
						...
						if (isset($_SESSION['eror'])) {
							...
							<div class='container'>
								<div class='alert alert-danger'>
									<span>
										<center>Username atau Password yang ada masukkan Salah! Validasi terlebih dahulu
										</center>
									</span>
								</div>
							</div>
