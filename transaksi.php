                    ...
                    <table class="table table-bordered table-invoice-full">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="right"></td>
                          <td class="right"></td>
                          <td class="right"><strong>Rp. <span id="total_biaya">
                  ...
                  <div class="widget-content nopadding">
                    <form action="#" method="post" class="form-horizontal">
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="number" id="uang_bayar" name="uang_bayar" class="span11" placeholder=""
                      ...
                      <p></p>
                      <center>
                        <button type="submit" value="<?php echo $result_harga['id_order']; ?>" name="save_order"
